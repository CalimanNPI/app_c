      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", }}>
            <AntDesign name="bells" size={20} color={COLORS.primaryR} />
            <Text style={[FONTS.body, { marginLeft: 10 }]}>Notificaciones</Text>
          </View>
        </TouchableOpacity>
        {isLogged && (
          <TouchableOpacity
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Feather name="log-out" size={20} color={COLORS.primaryR} />
              <Text style={[FONTS.body, { marginLeft: 10 }]}>Salir</Text>
            </View>
          </TouchableOpacity>
        )}
      </View>
